													...
													<div class="wrap-login100 p-l-55 p-r-65 p-t-40 p-b-50">
														<form action="signupproc.php" method="post">
															...
															<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
																	<input type="text" placeholder="First Name" pattern="[a-z]{1,15}" name="fname" required>
																<span class="focus-input100-1"></span>
																<span class="focus-input100-2"></span>
															</div>

															<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
																<input type="text" placeholder="Last Name" pattern="[a-z]{1,15}" name="lname" required>
																<span class="focus-input100-1"></span>
																<span class="focus-input100-2"></span>
															</div>

															<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
																 <input type="email" placeholder="Email" pattern="[^ @]*@[^ @]*" name="email" required>
																<span class="focus-input100-1"></span>
																<span class="focus-input100-2"></span>
															</div>
															...
															<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
																<input id="password"  type="password" placeholder="Password"class="pass1" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
