      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">Sign in</h1>
...
<p><br></p><p><br></p>
																			<div class="container-login100-form-btn m-t-20">
																				<input type="submit" id="submit" name="submit" value="Sign in" class="login100-form-btn">
																			</div>
																		  </form>
																			...
																			<div class="text-center">
																				...
																				<div>
																				<a href="logout.php" class="txt2 hov1">
																					Sign out
																				</a>
																			</div>
																			</div>
